...
import ru.job4j.lsp.parking.vehicles.ParkableSized;
...
public class VehiclesParkingTest {
    ...
    public void when3TrucksToSingleAnd3TrucksToLargeThenSuccess() {
        ...
        structure.put(5, 3);
        structure.put(1, 15);
        List<ParkableSized> trucks = List.of(
    ...
    public void when2Trucks5and2Trucks4and2Trucks3And2Cars() {
        ...
        trucks.get(0).setParkingSpaceSize(5);
        trucks.get(1).setParkingSpaceSize(5);
        trucks.get(2).setParkingSpaceSize(4);
        trucks.get(3).setParkingSpaceSize(4);
        trucks.get(4).setParkingSpaceSize(3);
        trucks.get(5).setParkingSpaceSize(3);
        Parking parking = new VehiclesParking(structure);
        cars.forEach(parking::add);
        trucks.forEach(parking::add);
        assertThat(cars.get(0).getParkingSpaceNumbers(), is(Set.of(1)));
        assertThat(cars.get(1).getParkingSpaceNumbers(), is(Set.of(2)));
        assertThat(trucks.get(0).getParkingSpaceNumbers(), is(Set.of(3)));
        assertThat(trucks.get(1).getParkingSpaceNumbers(), is(Set.of(4)));
        assertThat(trucks.get(2).getParkingSpaceNumbers(), is(Set.of(5)));
        assertThat(trucks.get(3).getParkingSpaceNumbers(), is(Set.of(6)));
        assertThat(trucks.get(4).getParkingSpaceNumbers(), is(Set.of(7)));
        assertThat(trucks.get(5).getParkingSpaceNumbers(), is(Set.of(8)));
    }
}